...
import { idlFactory } from './farmflow_frontend.did.js';
export { idlFactory } from './farmflow_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FARMFLOW_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./farmflow_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the farmflow_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./farmflow_frontend.did.js")._SERVICE>}
 */
export const farmflow_frontend = createActor(canisterId);
